...
class AppLocalizations {
  ...
  static const Map<String, String> _en = {
    ...
    'about_us_description': 'The Sudanese Students Association in Istanbul is a student organization that aims to gather Sudanese students studying in Turkish universities and provide them with academic, social, and cultural support.',
    'our_vision': 'Our Vision',
    'our_vision_text': 'Building a cohesive and cooperative student community',
    'our_mission': 'Our Mission',
    'our_mission_text': 'Providing comprehensive support to all students',
  ...
  static const Map<String, String> _ar = {
    ...
    'see_all': 'عرض الكل',
    'about_us': 'عن الرابطة',
    'about_us_description': 'رابطة الطلاب السودانيين في إسطنبول هي منظمة طلابية تهدف إلى جمع الطلاب السودانيين الدارسين في الجامعات التركية وتقديم الدعم الأكاديمي والاجتماعي والثقافي لهم.',
    'our_vision': 'رؤيتنا',
    'our_vision_text': 'بناء مجتمع طلابي متماسك ومتعاون',
    'our_mission': 'رسالتنا',
    'our_mission_text': 'تقديم الدعم الشامل لجميع الطلاب',
  ...
  static const Map<String, String> _tr = {
    ...
    'about_us_description': 'İstanbul\'daki Sudanlı Öğrenciler Birliği, Türk üniversitelerinde okuyan Sudanlı öğrencileri bir araya getirmeyi ve onlara akademik, sosyal ve kültürel destek sağlamayı amaçlayan bir öğrenci organizasyonudur.',
    'our_vision': 'Vizyonumuz',
    'our_vision_text': 'Kenetlenmiş ve yardımlaşan bir öğrenci topluluğu oluşturmak',
    'our_mission': 'Misyonumuz',
    'our_mission_text': 'Tüm öğrencilere kapsamlı destek sağlamak',
